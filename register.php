...
if($_SERVER["REQUEST_METHOD"] == "POST"){ // kur butoni submit klikohet
    ...
    } else{ // nese username nuk ka errore check if its used
    ...
    if(empty($inputErr)){ // nese nuk ka errore, insert te dhenat ne tabelen user
